  ...
  return (
    <>
      ...
      <section>
        ...
        <div className="modal">
          <div className="modal-box w-[1400px] max-w-5xl h-[800px] bg-white flex justify-start  ">
            {/* template value distrubuted by localstorage vitems */}
            <div className="relative  w-[550px] m-4 h-[740px]  bg-blue-200 border rounded-[10px] flex  ">
              <div
                id="resumepage"
                className="relative  w-[500px] m-1 h-[690px] bg-blue-200  "
              >
                <section class="text-gray-600 body-font relative bottom-[10px]">
                  <div class="container px-2 py- mx-auto">
                    ...
                    <img class="inline-block h-6 w-6 rounded-full ring-2 ring-white " src="https://images.unsplash.com/photo-1500648767791-00dcc994a43e?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2.25&w=256&h=256&q=80" alt=""/>
                      <h2 class="text-gray-900 text-[16px] title-font font-medium px-1">
